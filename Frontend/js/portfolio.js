    ...
    if (projects && projects.length && list) {
        list.innerHTML = projects.map((p, i) => {
            ...
            const imgContent = p.imagePath
                ? `<img src="${API_BASE}/uploads/${p.imagePath}" alt="${p.name}">`
                : `<svg class="placeholder-icon" width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>`;
